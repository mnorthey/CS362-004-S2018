...
* Assignment: #3 Card Test 3 - Steward
...
void testDraw()
{
	...
	gainCard(steward, &G, 2, 0);
	
	// Save conditions
	int hand_count = G.handCount[0];
	int deck_count = G.deckCount[0];
	int discard_count = G.discardCount[0];
	int coins = G.coins;
	...
	// Check that deck size decreased by two
	assertTrue("G.deckCount[0]", deck_count - 2, G.deckCount[0] + G.discardCount[0]);
	
	// Check that discard stayed the same
	assertTrue("G.discardCount[0]", discard_count, G.discardCount[0]);
	...
	discard_count = G.discardCount[0];
	coins = G.coins;
	...
	// Save conditions
	hand_count = G.handCount[0];
	deck_count = G.deckCount[0] + G.discardCount[0];
	coins = G.coins;
	...
	// Check that deck size decreased by two
	assertTrue("G.deckCount[0] + G.discardCount[0]", deck_count - 2, G.deckCount[0] + G.discardCount[0]);
...
void testCoins()
{
	...
	#if (NOISY_TEST == 1)
		printf("------------------------------------------------------------------\n");
		printf("TESTING Add Coin Behavior\n");
	#endif
	...
	// Check that hand size stays the same
	assertTrue("G.handCount[0]", hand_count - 1, G.handCount[0]);

	// Check that two coins were added
	assertTrue("G.coins", coins + 2, G.coins);
	
	// Check that deck size stayed the same
	assertTrue("G.deckCount[0]", deck_count, G.deckCount[0]);
...
void testTrash()
{
	...
	#if (NOISY_TEST == 1)
		printf("------------------------------------------------------------------\n");
		printf("TESTING Trash Card Behavior\n");
	#endif
	...
	// Check that hand size decreases by three
	assertTrue("G.handCount[0]", hand_count - 3, G.handCount[0]);

	// Check that coins decreased accordingly
	assertTrue("G.coins", coins, G.coins);
...
void printHand(int player, struct gameState *G)
{
	...
	for (i = 0; i < G->handCount[player]; i++)
	{
		...
		else if (G->hand[player][i] == curse)
		{
			printf(" curse,");
		}
		else if (G->hand[player][i] == estate)
		{
			printf(" estate,");
		}
		else if (G->hand[player][i] == duchy)
		{
			printf(" duchy,");
		}
		else if (G->hand[player][i] == province)
		{
			printf(" province,");
		}
		else if (G->hand[player][i] == adventurer)
		{
			printf(" adventurer,");
		}
		else if (G->hand[player][i] == council_room)
		{
			printf(" council_room,");
		}
		else if (G->hand[player][i] == feast)
		{
			printf(" feast,");
		}
		else if (G->hand[player][i] == gardens)
		{
			printf(" gardens,");
		}
		else if (G->hand[player][i] == mine)
		{
			printf(" mine,");
		}
		else if (G->hand[player][i] == remodel)
		{
			printf(" remodel,");
		}
		else if (G->hand[player][i] == smithy)
		{
			printf(" smithy,");
		}
		else if (G->hand[player][i] == village)
		{
			printf(" village,");
		}
		else if (G->hand[player][i] == baron)
		{
			printf(" baron,");
		}
		else if (G->hand[player][i] == great_hall)
		{
			printf(" great_hall,");
		}
		else if (G->hand[player][i] == minion)
		{
			printf(" minion,");
		}
		else if (G->hand[player][i] == steward)
		{
			printf(" steward,");
		}
		else if (G->hand[player][i] == tribute)
		{
			printf(" tribute,");
		}
		else if (G->hand[player][i] == ambassador)
		{
			printf(" ambassador,");
		}
		else if (G->hand[player][i] == cutpurse)
		{
			printf(" cutpurse,");
		}
		else if (G->hand[player][i] == embargo)
		{
			printf(" embargo,");
		}
		else if (G->hand[player][i] == outpost)
		{
			printf(" outpost,");
		}
		else if (G->hand[player][i] == salvager)
		{
			printf(" salvager,");
		}
		else if (G->hand[player][i] == sea_hag)
		{
			printf(" sea_hag,");
		}
		else if (G->hand[player][i] == treasure_map)
		{
			printf(" treasure_map,");
		}
		else
